...
| `AC-<US>-<n>` เช่น `AC-04-2` | **ยังไม่ได้ออก** | [[acceptance-criteria-v1\|Acceptance Criteria v1]] | **Acceptance criteria รายข้อ** — ให้ test case ผูกกลับได้ละเอียดกว่าระดับ `US-xx` |
...
- [[acceptance-criteria-v1|Acceptance Criteria v1]] — **สถานะ โครงเอกสาร (สร้าง 2026-08-16)** ทะเบียน AC ที่มี **ID ถาวร** (`AC-<US>-<n>`) พร้อมสถานะความพร้อมทดสอบรายข้อ (✅ วัดผลได้ / 🔶 เสนอแก้แล้วรอเคาะ / 🔴 วัดผลไม่ได้) · **เจ้าของคือ XAVIER — OKOYE เสนอแก้ได้แต่แก้เองไม่ได้** · หัวข้อ 5 บันทึกกรณีศึกษา 7 US ที่ AC เคยวัดผลไม่ได้และถูกปิดไปแล้ว (US-15 "และ/หรือ", US-02 "ใช้งานได้ดีบนมือถือ" ฯลฯ) · ยังต้องย้าย AC จาก [[product-backlog-v1|Product Backlog v1]] มาลงตารางหัวข้อ 4 ให้ครบ
