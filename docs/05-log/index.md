...
- [[changelog|Changelog]] — บันทึกเหตุการณ์และการตัดสินใจสำคัญแบบเรียงตามลำดับเวลา (ใหม่สุดอยู่บนสุด) เริ่มจากการสร้าง product backlog v1 ของระบบสั่งอาหารด้วย QR Code
