...
2. **[[02-technical/architecture-v1|architecture-v1]] §10 อ้าง `nfr-v1` ที่ไม่มีอยู่จริง** — NFR-06 ถูกระบุว่าเป็น exit criteria ของ Phase 0 แต่ไม่มีเอกสารต้นทางให้ตรวจ
