...
| [[deploy-runbook-v1\|Deploy Runbook v1]] | 🆕 ขั้นตอน deploy บน VPS ของ TNM — ปิดช่องว่างที่ `architecture-v1` §5.1/§5.2/§5.4 ทำเครื่องหมายว่า "ต้องเขียนใหม่" หลังย้ายจาก Vercel/Supabase · **แบ่งชัดเป็น "ทำตอนนี้ (demo)" กับ "ก่อนเปิดร้านจริง (R13/R14/R15)"** · รวมสิ่งที่ห้ามทำระหว่าง demo ที่เปิดให้คนนอกสั่ง (พร้อมเพย์เบอร์จริง · seed · พิมพ์ป้ายถาวร) | ใช้อยู่ |
