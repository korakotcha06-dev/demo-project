...
> **ยังไม่ตัดสินว่าจะวางไว้ตรงไหน** — ผูกกับ `orders` (อยู่ถาวรตามอายุออเดอร์) หรือกับ `customer_session` (ตายพร้อมรอบบริการ 24 ชม.) · ทางเลือกนี้เปลี่ยนความเสี่ยง PDPA คนละระดับ ดูข้อเสนอใน [[../../01-requirements/01-spec/acceptance-criteria-v1|Acceptance Criteria v1]] หัวข้อ 6
