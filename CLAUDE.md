...
สิ่งที่ build ไปแล้ว: schema เต็ม (24 ตาราง, INV-1..INV-10, RLS) + เส้นทาง dine-in (J1) ครบวง + NFR-11 PIN lock + **หน้าจอแอดมิน A-00..A-07 ครบ** = **20 จาก 23 หน้าจอ** (เหลือ S-03, S-04 ของช่องทางเคาน์เตอร์) — รายละเอียดพร้อมช่องว่างของเอกสารที่เจอตอนลงมือ อยู่ในบันทึก changelog วันที่ 2026-08-22
